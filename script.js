...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // francenel-milliadaire-banner
  const francenelContainer = document.getElementById('francenel-milliadaire-banner');
  if (francenelContainer) {
    // Définir le lien de la vidéo ici (ajoutez votre URL, ou laissez vide pour mode images)
    const videoUrl = 'https://cdn.shopify.com/videos/c/o/v/8747957409cc4beda31702abfcd4ed91.mp4'; // Exemple: 'https://example.com/your-video.mp4' ou vide ''
    ...
    if (videoUrl) {
      ...
      video.src = videoUrl;
      videoWrapper.style.display = 'block';
      document.querySelectorAll('.francenel-milliadaire-banner-image').forEach(img => {
        img.style.display = 'none';
      });
    } else {
      // Mode images : cacher wrapper vidéo et bouton son, add class for CSS adjustment
