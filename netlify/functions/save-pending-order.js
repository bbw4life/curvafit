...
exports.handler = async (event) => {
  ...
  try {
    ...
    if (!shipping || !item) {
      throw new Error("Missing shipping or item data");
    }
    ...
    if (!success) {
      throw new Error("Aucun nom d'onglet n'a fonctionné. Vérifie le nom exact dans ton Google Sheet.");
    }
